package com.bfbyxx.wccydriver.bar;
...
public class BottomBar extends View {
    ...
    private int titleColorBefore = Color.parseColor("#080808");
    private int titleColorAfter = Color.parseColor("#2C5BB3");
    ...
    //注意 BaseActivity 需要支持其他老版的 自行修改
